...
echo.
echo Exemplos:
echo   installer\build-installer.bat -Version 1.3.0 -FileVersion 1.3.0.0
echo   installer\build-installer.bat -Version 1.3.0 -SignThumbprint ABCDEF123456...
exit /b 1
